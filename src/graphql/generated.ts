...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, availableAt?: any | null, lessonType: LessonType, slug: string, title: string }> };
